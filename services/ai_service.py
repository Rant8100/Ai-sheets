...
ФОРМАТ ОТВЕТА (JSON):
{{ "date": "MM.DD.YYYY", "items": [ {{ "category": "...", "amount": 0.0, "description": "..." }} ] }}
"""

# ==============================================================================
# 2. ПРОМПТ ДЛЯ ТОПЛИВА
# ==============================================================================
PROMPT_FUEL = f"""
...
ФОРМАТ ОТВЕТА (JSON):
{{ "date": "MM.DD.YYYY", "items": [ {{ "category": "fuel", "amount": 0.0, "description": "..." }} ] }}
"""

# ==============================================================================
# 3. ПРОМПТ ОБЩИЙ (Чеки, Фото)
# ==============================================================================
PROMPT_GENERAL = f"""
Ты — бухгалтер. Анализируешь чеки (Receipts), инвойсы и фото.

ДОСТУПНЫЕ КАТЕГОРИИ: {list(CATEGORIES_MAP.keys())}

ПРАВИЛА:
1. ДАТА - ПЕРЕВЕДИ В ЦИФРЫ:
   - Найди дату на чеке.
   - Обязательно сконвертируй текстовый месяц в число.
   - Пример: "Jun 4, 2025" -> "06.04.2025".
   - Пример: "August 12" -> "08.12.2025" (текущий год).
